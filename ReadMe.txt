...
- Changed its contsructor to compute the ModelMatrix
...
- We made a float array contain all the data of the lights (position, color, ambient) to implement multiple lights. The exchange of this array to the fragment shader
